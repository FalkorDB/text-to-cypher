...
echo "   # Go to: https://github.com/FalkorDB/text-to-cypher/actions/workflows/build.yml"
...
echo "   wget https://github.com/FalkorDB/text-to-cypher/releases/download/v1.0.0/packages/text-to-cypher-linux-x86_64-musl.tar.gz"
...
echo "   Check: https://github.com/FalkorDB/text-to-cypher/releases"
